  ...
  <div class="wrapper">
    <div class="opendag">
        <div class="about">
          ...
          <img src="Fotos_locaties\Curio1.jpg" alt="">
        </div>  
        ...
        <div class="reviews">
          ...
          <div class="review1">
           <div class="text">
            ...
            <img src="Mbo\examen.jpg" alt="picture test">
          </div>
          <div class="review2">
            <div class="text">
              <h3>Lessen</h3>
          ...
          <div class="review4">
          <img src="img\Opleidingsoverzicht3.png" alt="picture test">
            <div class="text">
              <h3>Blokken</h3>
          ...
          <div class="smoelenboekje">
            <div class="smoel">
                <img src="img\teacher2.jpg" alt="">
                <h3>Michel Meeuwesen</h3>
            </div>
            <div class="smoel">
                <img src="img\new_teacher1.jpeg" alt="">
                <h3>Ine Vermeer</h3>
            </div>
            <div class="smoel">
                <img src="img\500x500.jpg" alt="">
                <h3>Elton Boekhoudt</h3>
            </div>
            <div class="smoel">
                <img src="img\leraar3.jpg" alt="">
                <h3>Bart Roos</h3>
            </div>
       </div>   
        </div>
